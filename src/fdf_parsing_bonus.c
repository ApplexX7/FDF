...
/*   Updated: 2024/01/24 10:23:15 by mohilali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf_bonus.h"

static size_t	len_withd(char **str)
{
	int	len;
...
static void	check_len_line(size_t len, int fd, char *str)
{
	char	**arr;
...
static int	ft_get_with(char *av)
{
	int		fd;
	char	*str;
	char	**par;
...
static int	ft_get_lenght(char *av)
{
	int		len;
	int		fd;
	char	*str;
